...
from combadge.browserbase import MAX_CONTENT_CHARS
from combadge.web_browser import WebBrowser
...
def test_navigation_waits_for_redirected_main_document(monkeypatch):
    async def scenario():
        ...
        monkeypatch.setattr("combadge.web_browser.asyncio.sleep", AsyncMock())
